...
class SimpleDecoding(nn.Module):
    ...
    def forward(self, x_c4, x_c3, x_c2, x_c1):
        print("C4 SHAPE: {}, C3 SHAPE: {}, C2 SHAPE: {}, C1 SHAPE: {}".format(x_c4.shape,x_c3.shape,x_c2.shape,x_c1.shape))
        #print(x_c4.shape, x_c3.shape, x_c2.shape, x_c1.shape)
        #print(x_c4.max(), x_c3.max(), x_c2.max(), x_c1.max(), x_c4.min(), x_c3.min(), x_c2.min(), x_c1.min())
        # fuse Y4 and Y3
